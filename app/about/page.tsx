  ...
  return (
    <ParallaxProvider>
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-slate-800 to-blue-900">
        ...
        {/* Glowing animation for timeline icons */}
        <style jsx global>{`
          @keyframes glow-loop {
            0%, 100% { filter: drop-shadow(0 0 0px #3b82f6) drop-shadow(0 0 0px #3b82f6); }
            50% { filter: drop-shadow(0 0 16px #3b82f6) drop-shadow(0 0 32px #3b82f6); }
          }
          .animate-glow-loop {
            animation: glow-loop 1.5s infinite alternate;
          }
          .animate-pulse-glow {
            box-shadow: 0 0 0 0 #3b82f6, 0 0 0 0 #3b82f6;
            animation: pulse-glow 1.5s infinite alternate;
          }
          @keyframes pulse-glow {
            0%, 100% { box-shadow: 0 0 0 0 #3b82f6, 0 0 0 0 #3b82f6; }
            50% { box-shadow: 0 0 16px 4px #3b82f6, 0 0 32px 8px #3b82f6; }
          }
        `}</style>
                        </>
                        {/* Content Card */}

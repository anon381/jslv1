	...
	theme: {
		   extend: {
			...
			keyframes: {
				...
				'scale-in': { '0%': { transform: 'scale(.85)', opacity: '0' }, '100%': { transform: 'scale(1)', opacity: '1' } },
				float: { '0%,100%': { transform: 'translateY(-4px)' }, '50%': { transform: 'translateY(4px)' } }
			},
			animation: {
				'accordion-down': 'accordion-down 0.2s ease-out',
				'accordion-up': 'accordion-up 0.2s ease-out',
				'ring-pulse': 'ringPulse 1.9s ease-out infinite',
				'orbit-spin': 'orbit 7s linear infinite',
				'orbit-spin-fast': 'orbit 3.5s linear infinite',
				'shimmer-bar': 'shimmer 1.8s linear infinite',
